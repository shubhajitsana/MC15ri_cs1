...
variable_name = []
variable_name.append("KSFWVariables__boet__bc")
variable_name.append("KSFWVariables__bohso20__bc")
variable_name.append("CleoConeCS__bo2__bc")
variable_name.append("KSFWVariables__bohso01__bc")
...
lower_range = []
lower_range.append(3)
lower_range.append(0)
lower_range.append(-0.1)
lower_range.append(-0.55)

upper_range = []
upper_range.append(12)
upper_range.append(1)
upper_range.append(6.5)
upper_range.append(0.55)

histogram_title = []
histogram_title.append("KSFW E_{t}")
histogram_title.append("KSFW H^{so}_{20}")
histogram_title.append("CLEO Cone (2)")
histogram_title.append("KSFW H^{so}_{01}")
...
if normalization == 1:
    output_filename = "cs_" + sys.argv[6] + "4_" + '_'.join(variable_name) + "_normalized"
else:
    output_filename = "cs_" + sys.argv[6] + "4_" + '_'.join(variable_name)
