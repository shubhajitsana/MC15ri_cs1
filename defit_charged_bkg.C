...
void defit_charged_bkg(){
  ...
  chain->Add("/home/belle2/ssana/MC15ri/cs_fom_data/combined/charged_bkg.root/tree");
    ...
    RooChebychev sum("bkg","Background",deltae,RooArgSet(b1)) ;
    sum.fitTo(*data);
    /****************************FIT COMPLETE*************************************/

    /*********************Start Plotting and showing outpouts*****************/
    //Plotting fitted result
    RooPlot* deframe = deltae.frame(Title("Fitting #DeltaE for charged Background"), Bins(300)) ;                          
    ...
    // entry = legend1->AddEntry("sig1","1st Gaussian pdf","l");
    ...
    // entry->SetLineStyle(kDashed);
    // TLegendEntry *entry = legend1->AddEntry("sum","Fitted pdf","l");
    ...
    c1->Print("de_plot/de_fit_charged_bkg.png");
