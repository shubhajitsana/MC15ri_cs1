...
variable_name = []
variable_name.append("KSFWVariables__bohso14__bc")
variable_name.append("KSFWVariables__bohoo4__bc")
variable_name.append("KSFWVariables__bohso03__bc")
variable_name.append("CleoConeCS__bo7__bc")
...
lower_range = []
lower_range.append(-0.3)
lower_range.append(-0.035)
lower_range.append(-0.35)
lower_range.append(-0.1)

upper_range = []
upper_range.append(0.3)
upper_range.append(0.045)
upper_range.append(0.35)
upper_range.append(3.5)

histogram_title = []
histogram_title.append("KSFW H^{so}_{14}")
histogram_title.append("KSFW H^{oo}_{4}")
histogram_title.append("KSFW H^{so}_{03}")
histogram_title.append("CLEO Cone (2)")
...
if normalization == 1:
    output_filename = "cs_" + sys.argv[6] + "8_" + '_'.join(variable_name) + "_normalized"
else:
    output_filename = "cs_" + sys.argv[6] + "8_" + '_'.join(variable_name)
