...
void roofit_Dstr3D_veto(){
    ...
    chain->SetBranchAddress("InvMD0and3rdpi",&de3);
    ...
    RooPlot* deframe = deltae.frame(Title("Fitting Invariant mass of 3^{rd} pion and #bar{D}^{0}"), Bins(150)) ;                          
    ...
    c1->Print("roofit_plot_veto/Dstr3D_md.png");
}