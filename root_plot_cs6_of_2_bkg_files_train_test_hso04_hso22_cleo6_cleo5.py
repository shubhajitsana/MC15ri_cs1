...
variable_name = []
variable_name.append("KSFWVariables__bohso04__bc")
variable_name.append("KSFWVariables__bohso22__bc")
variable_name.append("CleoConeCS__bo6__bc")
variable_name.append("CleoConeCS__bo5__bc")
...
upper_range = []
upper_range.append(0.5)
upper_range.append(0.4)
upper_range.append(3.8)
upper_range.append(4)

histogram_title = []
histogram_title.append("KSFW H^{so}_{04}")
histogram_title.append("KSFW H^{so}_{22}")
...
if normalization == 1:
    output_filename = "cs_" + sys.argv[6] + "6_" + '_'.join(variable_name) + "_normalized"
else:
    output_filename = "cs_" + sys.argv[6] + "6_" + '_'.join(variable_name)
