...
void roofit_K_s_23_veto(){
    ...
    chain->SetBranchAddress("InvM2ndand3rdpi",&de3);
    ...
    RooPlot* deframe = deltae.frame(Title("Fitting Invariant Mass of K_{S}^{0} from 2^{nd} and 3^{rd} pion"), Bins(150)) ;                          
    ...
    c1->Print("roofit_plot_veto/K_S0_InvM_23.png");
}