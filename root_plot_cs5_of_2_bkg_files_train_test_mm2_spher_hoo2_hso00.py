...
variable_name = []
variable_name.append("KSFWVariables__bomm2__bc")
variable_name.append("sphericity")
variable_name.append("KSFWVariables__bohoo2__bc")
variable_name.append("KSFWVariables__bohso00__bc")
...
lower_range = []
lower_range.append(-9)
lower_range.append(0)
lower_range.append(-0.06)
lower_range.append(0)

upper_range = []
upper_range.append(7)
upper_range.append(1)
upper_range.append(0.1)
upper_range.append(2.3)

histogram_title = []
histogram_title.append("KSFW M^{2}_{m}")
histogram_title.append("Sphericity")
histogram_title.append("KSFW H^{oo}_{2}")
histogram_title.append("KSFW H^{so}_{00}")
...
if normalization == 1:
    output_filename = "cs_" + sys.argv[6] + "5_" + '_'.join(variable_name) + "_normalized"
else:
    output_filename = "cs_" + sys.argv[6] + "5_" + '_'.join(variable_name)
