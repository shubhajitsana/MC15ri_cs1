...
variable_name = []
variable_name.append("KSFWVariables__bohso10__bc")
variable_name.append("KSFWVariables__bohso02__bc")
variable_name.append("thrustOm")
variable_name.append("CleoConeCS__bo1__bc")
...
lower_range.append(-0.7)
lower_range.append(0.5)
lower_range.append(-0.1)

upper_range = []
upper_range.append(1.85)
upper_range.append(0.9)
upper_range.append(1)
upper_range.append(5)

histogram_title = []
histogram_title.append("KSFW H^{so}_{10}")
histogram_title.append("KSFW H^{so}_{02}")
histogram_title.append("Thrust of rest of the event (T_{ROE})")
histogram_title.append("CLEO Cone (1)")
...
if normalization == 1:
    output_filename = "cs_" + sys.argv[6] + "3_" + '_'.join(variable_name) + "_normalized"
else:
    output_filename = "cs_" + sys.argv[6] + "3_" + '_'.join(variable_name)
