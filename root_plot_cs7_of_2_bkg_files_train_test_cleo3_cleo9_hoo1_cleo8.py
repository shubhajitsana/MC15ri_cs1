...
variable_name = []
variable_name.append("CleoConeCS__bo3__bc")
variable_name.append("CleoConeCS__bo9__bc")
variable_name.append("KSFWVariables__bohoo1__bc")
variable_name.append("CleoConeCS__bo8__bc")
...
lower_range.append(-0.1)
lower_range.append(-0.03)
lower_range.append(-0.1)

upper_range = []
upper_range.append(5.5)
upper_range.append(2.5)
upper_range.append(0.03)
upper_range.append(2.8)

histogram_title = []
histogram_title.append("CLEO Cone (2)")
histogram_title.append("CLEO Cone (2)")
histogram_title.append("KSFW H^{oo}_{1}")
histogram_title.append("CLEO Cone (2)")
...
if normalization == 1:
    output_filename = "cs_" + sys.argv[6] + "7_" + '_'.join(variable_name) + "_normalized"
else:
    output_filename = "cs_" + sys.argv[6] + "7_" + '_'.join(variable_name)
