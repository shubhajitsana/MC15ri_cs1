void root_plot_contprob_cont_non_cont(){
    TFile *fa = new TFile("cs_fom_data/combined/signal.root");
    TTree *ta = (TTree*)fa->Get("tree");
    TFile *fch = new TFile("cs_fom_data/combined/bbbar.root");
    ...
    // TH1F *mbcm = new TH1F("mbcm","mbcm", 100, 0, 1);
    TH1F *mbcu = new TH1F("mbcu","mbcu", 200, 0, 1);
    // TH1F *mbcd = new TH1F("mbcd","mbcd", 100, 0, 1);
    // TH1F *mbcs = new TH1F("mbcs","mbcs", 100, 0, 1);
    // TH1F *mbcc = new TH1F("mbcc","mbcc", 100, 0, 1);
    ...
    mbca->GetYaxis()->SetRangeUser(0,1400000);
    ...
    legend1->AddEntry(mbcch,"Non Continuum","l");
    // legend1->AddEntry(mbcm,"mixed","l");
    legend1->AddEntry(mbcu,"Continuum","l");
    ...
    c->Print("cs_fom_data/combined/continuum_probability_plot/continuum_probability_plot_cont_non_cont_200.png");
}