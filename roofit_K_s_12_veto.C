...
void roofit_K_s_12_veto(){
    /*******************Fit Variables***********************************/
    RooRealVar deltae("deltae","M (GeV)", 0.48, 0.51);
    ...
    chain->Add("/home/belle2/ssana/MC15ri/data/combined/all.root/tree");
    ...
    chain->SetBranchAddress("InvM1stand2ndpi",&de3);
    ...
    /*****************************Delta E Fit***********************/
    // --- Build Signal PDF ---
    RooRealVar mean1("mean1","mean of Gaussian-1",0.4976,0.493,0.501);
    RooRealVar mean2("mean2","mean of Gaussian-2",0.498,0.493,0.501);
    ...
    RooRealVar b1("Chbyshv-prm", "Chbyshv-prm", 0.016, -10., 10.);
    ...
    RooPlot* deframe = deltae.frame(Title("Fitting Invariant Mass of K_{S}^{0} from 1^{st} and 2^{nd} pion"), Bins(150)) ;                          
    ...
    frame3->GetXaxis()->SetTitle("#DeltaM (GeV)"); 
    ...
    c1->Print("roofit_plot_veto/K_S0_InvM_12.png");
}