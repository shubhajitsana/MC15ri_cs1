...
in2out2+="$output_path/test_deltaz_filtered_charged_signal_only.root "
in2out2+="$output_path/test_deltaz_filtered_signal_signal_only.root "
...
input_files="$output_path/test_deltaz_filtered_charged_signal_only.root "
input_files+="$output_path/test_deltaz_filtered_signal_signal_only.root "
