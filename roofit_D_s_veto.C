...
void roofit_D_s_veto(){
    /*******************Fit Variables***********************************/
    RooRealVar deltae("deltae","M (GeV)", 1.9, 2.1);
    ...
    chain->SetBranchAddress("D_s_InvM",&de3);
    ...
    /*****************************Delta E Fit***********************/
    // --- Build Signal PDF ---
    RooRealVar mean1("mean1","mean of Gaussian-1",1.9683,1.94,2.0);
    RooRealVar mean2("mean2","mean of Gaussian-2",1.97,1.94,2.0);
    ...
    RooPlot* deframe = deltae.frame(Title("Fitting Invariant Mass of D_{s}^{-}"), Bins(150)) ;                          
    ...
    c1->Print("roofit_plot_veto/D_s_InvM.png");
}