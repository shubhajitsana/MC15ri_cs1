...
void roofit_Dstr2D_veto(){
    ...
    chain->SetBranchAddress("InvMD0and2ndpi",&de3);
    ...
    RooPlot* deframe = deltae.frame(Title("Fitting Invariant mass of 2^{nd} pion and #bar{D}^{0}"), Bins(150)) ;                          
    ...
    double arrowHeight = counter*0.009;
    ...
    c1->Print("roofit_plot_veto/Dstr2D_md.png");
}