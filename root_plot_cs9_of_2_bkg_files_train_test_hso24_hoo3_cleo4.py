...
variable_name = []
variable_name.append("KSFWVariables__bohso24__bc")
variable_name.append("KSFWVariables__bohoo3__bc")
variable_name.append("CleoConeCS__bo4__bc")
...
lower_range = []
lower_range.append(-0.25)
lower_range.append(-0.019)
lower_range.append(-0.1)
# lower_range.append(0.55)

upper_range = []
upper_range.append(0.25)
upper_range.append(0.019)
upper_range.append(4.5)
# upper_range.append(1)

histogram_title = []
histogram_title.append("KSFW H^{so}_{24}")
histogram_title.append("KSFW H^{oo}_{3}")
...
if normalization == 1:
    output_filename = "cs_" + sys.argv[6] + "9_" + '_'.join(variable_name) + "_normalized"
else:
    output_filename = "cs_" + sys.argv[6] + "9_" + '_'.join(variable_name)
